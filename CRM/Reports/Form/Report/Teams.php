  ...
  function from() {
    ...
    $this->_from = "
         ...
         INNER JOIN civicrm_relationship {$this->_aliases['relationship']} ON {$this->_aliases['team']}.id = {$this->_aliases['relationship']}.contact_id_b 
         	AND {$this->_aliases['relationship']}.is_active = 1
         	AND ({$this->_aliases['relationship']}.start_date IS NULL OR {$this->_aliases['relationship']}.start_date <= NOW())
         	AND ({$this->_aliases['relationship']}.end_date IS NULL OR {$this->_aliases['relationship']}.end_date >= NOW())
